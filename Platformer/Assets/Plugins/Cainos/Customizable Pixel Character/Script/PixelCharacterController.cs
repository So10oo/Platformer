...
namespace Cainos.CustomizablePixelCharacter
{
    public class PixelCharacterController : MonoBehaviour
    {
        ...
        public void OnArrowDraw()
        {
            ...
            projectile = Instantiate(arrowPrefab, character.rigHandL).GetComponent<Projectile>();
        ...
        private void Attack()
        {
            ...
            {
                if (isCrawling == false && character.Weapon && character.Weapon.TryGetComponent<WeaponBow>(out bow))
                {
        ...
        private static readonly float GROUND_LIFT_LERP_SPEED = 7.5f;    //the lerp speed to lift the character above ground
        ...
        private void GroundLift()
        {
            ...
            Vector3 pos = transform.position;
            pos.y = Mathf.Lerp(pos.y, groundYPos , GROUND_LIFT_LERP_SPEED * Time.fixedDeltaTime);
            transform.position = pos;
